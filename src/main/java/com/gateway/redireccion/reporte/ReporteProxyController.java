package com.gateway.redireccion.reporte;
...
@RestController
@RequestMapping("/api/proxy/reporte")
...
public class ReporteProxyController {
    ...
    public ResponseEntity<?> proxyReporte(HttpServletRequest request,
                                                 @RequestBody(required = false) String body,
                                                 @RequestHeader HttpHeaders headers) {
        String originalPath = request.getRequestURI().replace("/api/proxy/reporte", "");
        String targetUrl = "http://localhost:8084/api/reporte" + originalPath;
